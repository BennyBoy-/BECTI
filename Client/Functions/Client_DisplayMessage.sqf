...
switch (_message_var) do {
	...
	case "award-bounty-basedefense": {CTI_P_ChatID commandChat format ["$%1 awarded for the neutralization of a %2 by your base defenses", _parameters select 0, _parameters select 1]};
	case "award-bounty-basedefense-player": {CTI_P_ChatID commandChat format ["$%1 awarded for the neutralization of %2 (%3) by your base defenses", _parameters select 0, _parameters select 1, _parameters select 2]};
