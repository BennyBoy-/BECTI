...
//--- Infantry Squads
WEST_TOWNS_SQUAD_RIFLEMEN1 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_AR, WEST_SOLDIER_AR, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_RIFLEMEN2 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_AR, WEST_SOLDIER_AR, WEST_SOLDIER_MG, WEST_SOLDIER_MG, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER_EXP, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_RIFLEMEN3 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_AR, WEST_SOLDIER_AR, WEST_SOLDIER_GL, WEST_SOLDIER_GL, WEST_SOLDIER_MG, WEST_SOLDIER_MG, WEST_SOLDIER_EXP, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_SNIPER = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_SNIPER, WEST_SOLDIER_SNIPER, WEST_SOLDIER_SNIPER, WEST_SOLDIER, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_AT1 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_LAT, WEST_SOLDIER_LAT, WEST_SOLDIER_LAT, WEST_SOLDIER_LAT, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER_EXP, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_AT2 = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_HAT, WEST_SOLDIER_HAT, WEST_SOLDIER_HAT, WEST_SOLDIER_HAT, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER_EXP, WEST_SOLDIER_MEDIC];
WEST_TOWNS_SQUAD_AA = [WEST_SOLDIER_SQUADLEADER, WEST_SOLDIER_AA, WEST_SOLDIER_AA, WEST_SOLDIER_AA, WEST_SOLDIER_AA, WEST_SOLDIER, WEST_SOLDIER, WEST_SOLDIER_EXP, WEST_SOLDIER_MEDIC];
