...
//--- CUP - TAKISTANI MILITARY TOWN OCCUPATION
    //--- Infantry
    GUER_SOLDIER = "CUP_O_TK_Soldier";
    GUER_SOLDIER_AA = "CUP_O_TK_Soldier_AA";
    GUER_SOLDIER_AR = "CUP_O_TK_Soldier_AR";
    GUER_SOLDIER_AT = "CUP_O_TK_Soldier_AT";
    GUER_SOLDIER_CREW = "CUP_O_TK_Crew";
    GUER_SOLDIER_LAT = "CUP_O_TK_Soldier_LAT";
    GUER_SOLDIER_HAT = "CUP_O_TK_Soldier_HAT";
    GUER_SOLDIER_ENGINEER = "CUP_O_TK_Engineer";
    GUER_SOLDIER_EXP = "CUP_O_TK_Engineer";
    GUER_SOLDIER_GL = "CUP_O_TK_Soldier_GL";
    GUER_SOLDIER_MEDIC = "CUP_O_TK_Medic";
    GUER_SOLDIER_MG = "CUP_O_TK_Soldier_MG";
    GUER_SOLDIER_PILOT = "CUP_O_TK_Pilot";
    GUER_SOLDIER_SNIPER = "CUP_O_TK_Sniper_KSVK";
    GUER_SOLDIER_TEAMLEADER = "CUP_O_TK_Soldier_SL";
    GUER_SOLDIER_SQUADLEADER = "CUP_O_TK_Officer";
    //--- Naval Infantry
    GUER_SOLDIER_NAVAL_INFANTRY = "CUP_O_TK_SpecOps";
    GUER_SOLDIER_NAVAL_SQUADLEADER = "CUP_O_TK_SpecOps_TL";
    //--- Light Vehicles
