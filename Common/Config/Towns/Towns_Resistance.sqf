...
if (CTI_TOWNS_OCCUPATION_RESISTANCE == 10) then { 
//--- Iron Front 3 IF3 Forces
	//--- Infantry
	GUER_SOLDIER = "LIB_FFI_Soldier_1";
	GUER_SOLDIER_AA = "LIB_WP_Medic";
	GUER_SOLDIER_AR = "LIB_WP_Starszy_saper";
	GUER_SOLDIER_AT = "LIB_DAK_AT_soldier";
	GUER_SOLDIER_CREW = "LIB_WP_Starsy_strzelec";
	GUER_SOLDIER_LAT = "LIB_WP_AT_grenadier";
	GUER_SOLDIER_HAT = "LIB_DAK_AT_soldier";
	GUER_SOLDIER_ENGINEER = "LIB_WP_saper";
	GUER_SOLDIER_EXP = "LIB_WP_Porucznic";
	GUER_SOLDIER_GL = "LIB_WP_AT_grenadier";
	GUER_SOLDIER_MEDIC = "LIB_WP_medic";
	GUER_SOLDIER_MG = "LIB_WP_Mgunner";
	GUER_SOLDIER_PILOT = "LIB_WP_Stggunner";
	GUER_SOLDIER_SNIPER = "LIB_WP_Sniper";
	GUER_SOLDIER_TEAMLEADER = "LIB_FFI_Soldier_3";
	GUER_SOLDIER_SQUADLEADER = "LIB_FFI_Soldier_1";  
	//--- Naval Infantry
	GUER_SOLDIER_NAVAL_INFANTRY = "";
	GUER_SOLDIER_NAVAL_SQUADLEADER = "";
	//--- Light Vehicles
	GUER_VEHICLE_LIGHT1 = ["LIB_CIV_FFI_CitC4"];
	GUER_VEHICLE_LIGHT2 = ["LIB_CIV_FFI_CitC4_4"];
	GUER_VEHICLE_LIGHT3 = ["LIB_CIV_FFI_CitC4_3"];
	GUER_VEHICLE_LIGHT4 = [""];
	GUER_VEHICLE_LIGHT5 = [""];
	GUER_VEHICLE_LIGHT6 = [""];
	GUER_VEHICLE_LIGHT7 = [""];
	//--- APCs
	GUER_VEHICLE_APC1 = ["LIB_SdKfz251_captured_FFV"];
	GUER_VEHICLE_APC2 = [""];
	GUER_VEHICLE_APC3 = [""];
	//--- Tanks
	GUER_VEHICLE_ARMORED1 = ["LIB_T34_76"];	
	GUER_VEHICLE_ARMORED2 = [""];
	GUER_VEHICLE_ARMORED3 = [""];
	//--- AA Vehicles
	GUER_VEHICLE_AA1 = [""];
	GUER_VEHICLE_AA2 = [""];
	GUER_VEHICLE_AA3 = [""];
	...
	GUER_AIR_CAS = [""];
	//--- Boats
	GUER_NAVAL_ASSAULT_BOAT1 = [""];
	GUER_NAVAL_ASSAULT_BOAT2 = [""];
	GUER_NAVAL_MEDIUM_ASSAULT_BOAT = [""];
	GUER_NAVAL_LARGE_ASSAULT_BOAT = [""];
