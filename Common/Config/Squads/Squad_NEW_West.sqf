...
[_side, _names, _label, _members, _factories] call compile preprocessFileLineNumbers "Common\Config\Squads\Squads_NEW_Set.sqf";
...
// missionNamespace setVariable [format["CTI_SQUADS_%1_KIND_HEAVY", _side], ["Mechanized", "MechanizedTracked", "Armored", "AntiAir"]];
