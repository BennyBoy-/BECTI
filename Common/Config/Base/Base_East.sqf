...
if (CTI_FACTION_EAST == 3) then {
	//IF3 USA/SOV
	missionNamespace setVariable [format["CTI_%1_HQ", _side], "LIB_US_M3_Halftrack"]; 
};
...
//If IF3 is not turned on, allow the statics below
if (CTI_IF3_ADDON == 0) then { 
...
_headers pushBack 		"Soviet M30 MG";
_classes pushBack 		"LIB_maxim_m30_base";
_prices pushBack 		1000;
_placements pushBack 	[180, 5];
_categories pushBack 	"Defense";
_coinmenus pushBack 	["HQ", "RepairTruck"];
...
_headers pushBack 		"Soviet AT Gun";
_classes pushBack 		"LIB_Zis3";
_prices pushBack 		6000;
_placements pushBack 	[180, 5];
_categories pushBack 	"Defense";
_coinmenus pushBack 	["HQ", "RepairTruck"];
...
_classes pushBack 		"LIB_SU_Searchlight";
_prices pushBack 		500;
_placements pushBack 	[180, 5];
_categories pushBack 	"Defense";
_coinmenus pushBack 	["HQ", "RepairTruck"];
...
_headers pushBack 		"AA Soviet Flak 61k Cannon (low rate)";
_classes pushBack 		"LIB_61K";
_prices pushBack 		6000;
_placements pushBack 	[180, 5];
_categories pushBack 	"Defense";
_coinmenus pushBack 	["HQ", "RepairTruck"];
