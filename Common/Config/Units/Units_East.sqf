...
_p pushBack '';
_n pushBack 'Jeep Static Transport';
_o pushBack 350;
_t pushBack 10;
_u pushBack 0;
_f pushBack CTI_FACTORY_LIGHT;
...
_c pushBack 'O_Heli_Transport_04_F'; 
_p pushBack '';
_n pushBack 'Taru Vehicle Tansport';
_o pushBack 5000;
_t pushBack 40;
_u pushBack 0;
_f pushBack CTI_FACTORY_AIR;
