...
(west) call compile preprocessFileLineNumbers "Common\Config\Units\Units_IF3_WEST.sqf";
(east) call compile preprocessFileLineNumbers "Common\Config\Units\Units_IF3_EAST.sqf";
};
