...
CTI_SQUAD_LABEL = 0;
CTI_SQUAD_MINCOST = 1;
CTI_SQUAD_COMPOSITION = 2;
CTI_SQUAD_FACTORY = 3;
CTI_SQUAD_UPGRADELEVEL = 4;
...
CTI_VOTE_TIME = [60, 10] select CTI_DEBUG; //--- Commander Vote time
...
with missionNamespace do {
	...
	if (isNil 'CTI_ECONOMY_STARTUP_SUPPLY_EAST') then {CTI_ECONOMY_STARTUP_SUPPLY_EAST = 8000};
	if (isNil 'CTI_ECONOMY_STARTUP_SUPPLY_WEST') then {CTI_ECONOMY_STARTUP_SUPPLY_WEST = 8000};
