...
//--- Determine whether we're dealing with resistance or occupation town
...
//--- Store the town groups in a variable for an easier access
...
//--- Make sure that we have at least one group to create
