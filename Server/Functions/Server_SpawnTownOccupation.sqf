...
if (isNil {_town getVariable "cti_naval"}) then {
	switch (true) do {
		case (_value < 50) : { 
			_pool_units = [
				["TOWNS_SQUAD_RIFLEMEN1", 2],
				["TOWNS_SQUAD_RIFLEMEN2", 1],
				["TOWNS_SQUAD_RIFLEMEN3", 1, 75],
				["TOWNS_SQUAD_AT1", 1],				
				[
					["TOWNS_SQUAD_LIGHT1_MIXED", 1, 50],
